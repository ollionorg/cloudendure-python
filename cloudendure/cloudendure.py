...
endpoint = '/api/latest/{}'
env_machines: str = os.environ.get('CLOUDENDURE_MACHINES', 'SG6524KMSP')
_machines: List[str] = env_machines.split(',')
global_project_id: str = os.environ.get('CLOUDENDURE_PROJECT_ID', 'f6f40681-dee0-4bf5-b978-98e93cd4db69')
global_project_name: str = os.environ.get('CLOUDENDURE_PROJECT_NAME', 'AirProducts')
