...
class AccountApi:
    ...
    def accounts_account_id_get(self, account_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.accounts_account_id_get_with_http_info(
                account_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.accounts_account_id_get_with_http_info(
                account_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def accounts_account_id_get_with_http_info(
        ...
        if "account_id" not in params or params["account_id"] is None:
            raise ValueError(
                "Missing the required parameter `account_id` when calling `accounts_account_id_get`"
            )  # noqa: E501
