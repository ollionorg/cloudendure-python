...
class AccountApi:
    ...
    def accounts_account_id_get(self, account_id, **kwargs):  # noqa: E501
        ...
        :return: CloudEndureAccount
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.accounts_account_id_get_with_http_info(account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.accounts_account_id_get_with_http_info(account_id, **kwargs)  # noqa: E501
            return data

    def accounts_account_id_get_with_http_info(self, account_id, **kwargs):  # noqa: E501
        """Get Account information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accounts_account_id_get_with_http_info(account_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('account_id' not in params or
            ...
            raise ValueError("Missing the required parameter `account_id` when calling `accounts_account_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CloudEndureAccount',  # noqa: E501
