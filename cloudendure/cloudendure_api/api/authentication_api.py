...
class AuthenticationApi:
    ...
    def login_post(self, body, **kwargs):  # noqa: E501
        ...
        @todo: fix re use of XSRF-TOKEN cookie + X-XSRF-TOKEN header Upon successful authentication, this method returns a session identifier cookie that can be used to authenticate subsequent API calls.   # noqa: E501
        ...
        :param object body: Login info (required)
    ...
    def login_post_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `login_post`"
            )  # noqa: E501
