...
class LicensingApi:
    ...
    def licenses_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CloudEndureLicenseList',  # noqa: E501
    ...
    def licenses_license_id_get(self, license_id, **kwargs):  # noqa: E501
        ...
        :return: CloudEndureLicense
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.licenses_license_id_get_with_http_info(license_id, **kwargs)  # noqa: E501
        else:
            (data) = self.licenses_license_id_get_with_http_info(license_id, **kwargs)  # noqa: E501
            return data

    def licenses_license_id_get_with_http_info(self, license_id, **kwargs):  # noqa: E501
        """Get License  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.licenses_license_id_get_with_http_info(license_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method licenses_license_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('license_id' not in params or
            ...
            raise ValueError("Missing the required parameter `license_id` when calling `licenses_license_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CloudEndureLicense',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
