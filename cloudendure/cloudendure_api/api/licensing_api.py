...
class LicensingApi:
    ...
    def licenses_license_id_get(self, license_id, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.licenses_license_id_get_with_http_info(
                license_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.licenses_license_id_get_with_http_info(
                license_id, **kwargs
            )  # noqa: E501
            return data

    def licenses_license_id_get_with_http_info(
        self, license_id, **kwargs
    ):  # noqa: E501
        """Get License  # noqa: E501
        ...
        if "license_id" not in params or params["license_id"] is None:
            raise ValueError(
                "Missing the required parameter `license_id` when calling `licenses_license_id_get`"
            )  # noqa: E501
