...
class UserApi:
    ...
    def change_password_post(self, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.change_password_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.change_password_post_with_http_info(body, **kwargs)  # noqa: E501
            return data
    ...
    def change_password_post_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `change_password_post`")  # noqa: E501
    ...
    def users_user_id_patch(self, body, user_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_user_id_patch_with_http_info(body, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.users_user_id_patch_with_http_info(body, user_id, **kwargs)  # noqa: E501
            return data
    ...
    def users_user_id_patch_with_http_info(self, body, user_id, **kwargs):  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `users_user_id_patch`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `users_user_id_patch`")  # noqa: E501
