...
class UserApi:
    ...
    def change_password_post(self, body, **kwargs):  # noqa: E501
        """Change Password  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.change_password_post(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.change_password_post_with_http_info(
                body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.change_password_post_with_http_info(
                body, **kwargs
            )  # noqa: E501
            return data

    def change_password_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Change Password  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.change_password_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method change_password_post" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `change_password_post`"
            )  # noqa: E501
    ...
    def me_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method me_get" % key
                )
            params[key] = val
        del params["kwargs"]
    ...
    def users_user_id_delete(self, user_id, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.users_user_id_delete_with_http_info(
                user_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.users_user_id_delete_with_http_info(
                user_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def users_user_id_delete_with_http_info(self, user_id, **kwargs):  # noqa: E501
        ...
        if "user_id" not in params or params["user_id"] is None:
            raise ValueError(
                "Missing the required parameter `user_id` when calling `users_user_id_delete`"
            )  # noqa: E501
    ...
    def users_user_id_patch(self, body, user_id, **kwargs):  # noqa: E501
        """Modify user settings  # noqa: E501

        Configure which projects this user can receive e-mail notifications for.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_user_id_patch(body, user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CloudEndureUser body: (required)
        :param str user_id: (required)
        :return: CloudEndureUser
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.users_user_id_patch_with_http_info(
                body, user_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.users_user_id_patch_with_http_info(
                body, user_id, **kwargs
            )  # noqa: E501
            return data

    def users_user_id_patch_with_http_info(self, body, user_id, **kwargs):  # noqa: E501
        """Modify user settings  # noqa: E501

        Configure which projects this user can receive e-mail notifications for.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_user_id_patch_with_http_info(body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `users_user_id_patch`"
            )  # noqa: E501
        # verify the required parameter 'user_id' is set
        if "user_id" not in params or params["user_id"] is None:
            raise ValueError(
                "Missing the required parameter `user_id` when calling `users_user_id_patch`"
            )  # noqa: E501
