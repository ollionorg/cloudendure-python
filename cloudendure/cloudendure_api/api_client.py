# -*- coding: utf-8 -*-
"""Define the CloudEndure API client module."""
...
import cloudendure.cloudendure_api.models
from cloudendure import cloudendure_api
from cloudendure.cloudendure_api import rest
...
class ApiClient:
    ...
    def __init__(self, configuration: Configuration = None, header_name: str = '', header_value=None, cookie=None):
        ...
        self.user_agent = 'cloudendure/0.1.0/python'
    ...
    def __call_api(
        ...
        # request url
        url = f'{self.configuration.host}{resource_path}'
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if isinstance(obj, dict):
            ...
            obj_dict = {
                ...
                for attr, _ in six.iteritems(obj.swagger_types) if getattr(obj, attr) is not None
            }
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cloudendure.cloudendure_api.models, klass)
    ...
    def call_api(
        ...
        :param _request_timeout: timeout setting for this request. If one number provided, it will
        ...
        if not async_req:
            return self.__call_api(
                resource_path, method, path_params, query_params, header_params, body, post_params, files,
                response_type, auth_settings, _return_http_data_only, collection_formats, _preload_content,
                _request_timeout
            )
        else:
    ...
    def select_header_accept(self, accepts):
        """Return the `Accept` based on an array of accepts provided.
    ...
    def select_header_content_type(self, content_types):
        """Return the `Content-Type` based on an array of content_types provided.
    ...
    def update_params_for_auth(self, headers, queries, auth_settings):
        """Update the header and query params based on authentication setting.
