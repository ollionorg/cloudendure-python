...
class CloudEndureAccountsList:
    ...
    """
    swagger_types = {"items": "list[CloudEndureAccount]"}

    attribute_map = {"items": "items"}

    def __init__(self, items=None):  # noqa: E501
        """CloudEndureAccountsList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureAccountsList.  # noqa: E501


        :return: The items of this CloudEndureAccountsList.  # noqa: E501
        :rtype: list[CloudEndureAccount]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureAccountsList.


        :param items: The items of this CloudEndureAccountsList.  # noqa: E501
        :type: list[CloudEndureAccount]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureAccountsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureAccountsList):
            return False
