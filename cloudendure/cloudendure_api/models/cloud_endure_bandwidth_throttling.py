...
class CloudEndureBandwidthThrottling:
    ...
    def __init__(self, bandwidth_throttling=None):  # noqa: E501
        """CloudEndureBandwidthThrottling - a model defined in Swagger"""  # noqa: E501
    ...
    def bandwidth_throttling(self):
        """Gets the bandwidth_throttling of this CloudEndureBandwidthThrottling.  # noqa: E501

        Mbps to use for Data Replication (zero means no throttling).  # noqa: E501

        :return: The bandwidth_throttling of this CloudEndureBandwidthThrottling.  # noqa: E501
        :rtype: int
        """
    ...
    def bandwidth_throttling(self, bandwidth_throttling):
        """Sets the bandwidth_throttling of this CloudEndureBandwidthThrottling.

        Mbps to use for Data Replication (zero means no throttling).  # noqa: E501

        :param bandwidth_throttling: The bandwidth_throttling of this CloudEndureBandwidthThrottling.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureBandwidthThrottling):
            return False
