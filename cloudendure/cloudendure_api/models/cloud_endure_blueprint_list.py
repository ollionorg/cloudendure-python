...
from cloudendure.cloudendure_api.models.cloud_endure_blueprint import CloudEndureBlueprint  # noqa: F401,E501


class CloudEndureBlueprintList:
    ...
    """
    swagger_types = {
        'items': 'list[CloudEndureBlueprint]'
    }
    ...
    def __init__(self, items=None):  # noqa: E501
        """CloudEndureBlueprintList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureBlueprintList.  # noqa: E501


        :return: The items of this CloudEndureBlueprintList.  # noqa: E501
        :rtype: list[CloudEndureBlueprint]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureBlueprintList.


        :param items: The items of this CloudEndureBlueprintList.  # noqa: E501
        :type: list[CloudEndureBlueprint]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureBlueprintList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureBlueprintList):
            return False
