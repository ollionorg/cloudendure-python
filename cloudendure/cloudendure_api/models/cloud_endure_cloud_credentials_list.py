...
from cloudendure.cloudendure_api.models.cloud_endure_cloud_credentials import (  # noqa: F401,E501
...
class CloudEndureCloudCredentialsList:
    ...
    """
    swagger_types = {"items": "list[CloudEndureCloudCredentials]"}

    attribute_map = {"items": "items"}

    def __init__(self, items=None):  # noqa: E501
        """CloudEndureCloudCredentialsList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureCloudCredentialsList.  # noqa: E501


        :return: The items of this CloudEndureCloudCredentialsList.  # noqa: E501
        :rtype: list[CloudEndureCloudCredentials]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureCloudCredentialsList.


        :param items: The items of this CloudEndureCloudCredentialsList.  # noqa: E501
        :type: list[CloudEndureCloudCredentials]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureCloudCredentialsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureCloudCredentialsList):
            return False
