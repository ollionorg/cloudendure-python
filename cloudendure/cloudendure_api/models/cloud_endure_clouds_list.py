...
from cloudendure.cloudendure_api.models.cloud_endure_cloud import CloudEndureCloud  # noqa: F401,E501


class CloudEndureCloudsList:
    ...
    def __init__(self, items=None):  # noqa: E501
        """CloudEndureCloudsList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureCloudsList.  # noqa: E501


        :return: The items of this CloudEndureCloudsList.  # noqa: E501
        :rtype: list[CloudEndureCloud]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureCloudsList.


        :param items: The items of this CloudEndureCloudsList.  # noqa: E501
        :type: list[CloudEndureCloud]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureCloudsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureCloudsList):
            return False
