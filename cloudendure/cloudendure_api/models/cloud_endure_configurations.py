...
class CloudEndureConfigurations:
    ...
    def __init__(self, name=None, value=None):  # noqa: E501
        """CloudEndureConfigurations - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._value = None
    ...
    @property
    def name(self):
        """Gets the name of this CloudEndureConfigurations.  # noqa: E501


        :return: The name of this CloudEndureConfigurations.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CloudEndureConfigurations.


        :param name: The name of this CloudEndureConfigurations.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this CloudEndureConfigurations.  # noqa: E501


        :return: The value of this CloudEndureConfigurations.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureConfigurations, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureConfigurations):
            return False
