...
class CloudEndureJobsList:
    ...
    """
    swagger_types = {"items": "list[CloudEndureJob]"}

    attribute_map = {"items": "items"}

    def __init__(self, items=None):  # noqa: E501
        """CloudEndureJobsList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureJobsList.  # noqa: E501


        :return: The items of this CloudEndureJobsList.  # noqa: E501
        :rtype: list[CloudEndureJob]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureJobsList.


        :param items: The items of this CloudEndureJobsList.  # noqa: E501
        :type: list[CloudEndureJob]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureJobsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureJobsList):
            return False
