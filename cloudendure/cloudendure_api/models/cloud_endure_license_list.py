...
from cloudendure.cloudendure_api.models.cloud_endure_license import CloudEndureLicense  # noqa: F401,E501


class CloudEndureLicenseList:
    ...
    def __init__(self, items=None):  # noqa: E501
        """CloudEndureLicenseList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureLicenseList.  # noqa: E501


        :return: The items of this CloudEndureLicenseList.  # noqa: E501
        :rtype: list[CloudEndureLicense]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureLicenseList.


        :param items: The items of this CloudEndureLicenseList.  # noqa: E501
        :type: list[CloudEndureLicense]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureLicenseList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureLicenseList):
            return False
