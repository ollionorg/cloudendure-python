...
class CloudEndureMachineSnapshotCredits:
    ...
    def __init__(self, credits=None):  # noqa: E501
        """CloudEndureMachineSnapshotCredits - a model defined in Swagger"""  # noqa: E501
        self._credits = None
    ...
    @property
    def credits(self):
        """Gets the credits of this CloudEndureMachineSnapshotCredits.  # noqa: E501

        Mbps to use for Data Replication (zero means no throttling).  # noqa: E501

        :return: The credits of this CloudEndureMachineSnapshotCredits.  # noqa: E501
        :rtype: int
        """
    ...
    def credits(self, credits):
        """Sets the credits of this CloudEndureMachineSnapshotCredits.

        Mbps to use for Data Replication (zero means no throttling).  # noqa: E501

        :param credits: The credits of this CloudEndureMachineSnapshotCredits.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureMachineSnapshotCredits, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureMachineSnapshotCredits):
            return False
