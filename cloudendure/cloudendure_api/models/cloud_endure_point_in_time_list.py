...
class CloudEndurePointInTimeList:
    ...
    """
    swagger_types = {"items": "list[CloudEndurePointInTime]"}

    attribute_map = {"items": "items"}

    def __init__(self, items=None):  # noqa: E501
        """CloudEndurePointInTimeList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndurePointInTimeList.  # noqa: E501


        :return: The items of this CloudEndurePointInTimeList.  # noqa: E501
        :rtype: list[CloudEndurePointInTime]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndurePointInTimeList.


        :param items: The items of this CloudEndurePointInTimeList.  # noqa: E501
        :type: list[CloudEndurePointInTime]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndurePointInTimeList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndurePointInTimeList):
            return False
