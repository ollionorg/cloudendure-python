...
class CloudEndureProjectsAndUsers:
    ...
    def __init__(self, items=None):  # noqa: E501
        """CloudEndureProjectsAndUsers - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureProjectsAndUsers.  # noqa: E501


        :return: The items of this CloudEndureProjectsAndUsers.  # noqa: E501
        :rtype: list[object]
        """
        return self._items
    ...
    def items(self, items):
        """Sets the items of this CloudEndureProjectsAndUsers.


        :param items: The items of this CloudEndureProjectsAndUsers.  # noqa: E501
        :type: list[object]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureProjectsAndUsers, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureProjectsAndUsers):
            return False
