...
from cloudendure.cloudendure_api.models.cloud_endure_project import CloudEndureProject  # noqa: F401,E501


class CloudEndureProjectsList:
    ...
    def __init__(self, items=None):  # noqa: E501
        """CloudEndureProjectsList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureProjectsList.  # noqa: E501


        :return: The items of this CloudEndureProjectsList.  # noqa: E501
        :rtype: list[CloudEndureProject]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureProjectsList.


        :param items: The items of this CloudEndureProjectsList.  # noqa: E501
        :type: list[CloudEndureProject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureProjectsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureProjectsList):
            return False
