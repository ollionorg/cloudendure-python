...
class CloudEndureRecoveryPlanSteps:
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureRecoveryPlanSteps.  # noqa: E501


        :return: The items of this CloudEndureRecoveryPlanSteps.  # noqa: E501
        :rtype: list[CloudEndureRecoveryPlanStep]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureRecoveryPlanSteps.


        :param items: The items of this CloudEndureRecoveryPlanSteps.  # noqa: E501
        :type: list[CloudEndureRecoveryPlanStep]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureRecoveryPlanSteps):
            return False
