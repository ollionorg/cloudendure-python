...
class CloudEndureRegionsList:
    ...
    """
    swagger_types = {"items": "list[CloudEndureRegion]"}

    attribute_map = {"items": "items"}

    def __init__(self, items=None):  # noqa: E501
        """CloudEndureRegionsList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureRegionsList.  # noqa: E501


        :return: The items of this CloudEndureRegionsList.  # noqa: E501
        :rtype: list[CloudEndureRegion]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureRegionsList.


        :param items: The items of this CloudEndureRegionsList.  # noqa: E501
        :type: list[CloudEndureRegion]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureRegionsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureRegionsList):
            return False
