...
class CloudEndureReplicationServerConfig:
    ...
    """
    swagger_types = {"volumes": "list[object]"}

    attribute_map = {"volumes": "volumes"}

    def __init__(self, volumes=None):  # noqa: E501
        """CloudEndureReplicationServerConfig - a model defined in Swagger"""  # noqa: E501
        self._volumes = None
    ...
    @property
    def volumes(self):
        """Gets the volumes of this CloudEndureReplicationServerConfig.  # noqa: E501


        :return: The volumes of this CloudEndureReplicationServerConfig.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def volumes(self, volumes):
        """Sets the volumes of this CloudEndureReplicationServerConfig.


        :param volumes: The volumes of this CloudEndureReplicationServerConfig.  # noqa: E501
        :type: list[object]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureReplicationServerConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureReplicationServerConfig):
            return False
