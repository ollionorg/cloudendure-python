...
from cloudendure.cloudendure_api.models.cloud_endure_usage import CloudEndureUsage  # noqa: F401,E501


class CloudEndureUsageList:
    ...
    def __init__(self, items=None):  # noqa: E501
        """CloudEndureUsageList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureUsageList.  # noqa: E501


        :return: The items of this CloudEndureUsageList.  # noqa: E501
        :rtype: list[CloudEndureUsage]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureUsageList.


        :param items: The items of this CloudEndureUsageList.  # noqa: E501
        :type: list[CloudEndureUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureUsageList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureUsageList):
            return False
