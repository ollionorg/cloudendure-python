...
from cloudendure.cloudendure_api.models.cloud_endure_user_report import CloudEndureUserReport  # noqa: F401,E501


class CloudEndureUserReports:
    ...
    """
    swagger_types = {
        'items': 'list[CloudEndureUserReport]'
    }
    ...
    def __init__(self, items=None):  # noqa: E501
        """CloudEndureUserReports - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureUserReports.  # noqa: E501


        :return: The items of this CloudEndureUserReports.  # noqa: E501
        :rtype: list[CloudEndureUserReport]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureUserReports.


        :param items: The items of this CloudEndureUserReports.  # noqa: E501
        :type: list[CloudEndureUserReport]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureUserReports, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureUserReports):
            return False
