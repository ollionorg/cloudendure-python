...
class CloudEndureUsersAndRoles:
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureUsersAndRoles.  # noqa: E501


        :return: The items of this CloudEndureUsersAndRoles.  # noqa: E501
        :rtype: list[object]
        """
        return self._items
    ...
    def items(self, items):
        """Sets the items of this CloudEndureUsersAndRoles.


        :param items: The items of this CloudEndureUsersAndRoles.  # noqa: E501
        :type: list[object]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureUsersAndRoles):
            return False
