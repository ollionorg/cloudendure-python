...
class CloudEndureUsersList:
    ...
    """
    swagger_types = {"items": "list[CloudEndureUser]"}

    attribute_map = {"items": "items"}

    def __init__(self, items=None):  # noqa: E501
        """CloudEndureUsersList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CloudEndureUsersList.  # noqa: E501


        :return: The items of this CloudEndureUsersList.  # noqa: E501
        :rtype: list[CloudEndureUser]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CloudEndureUsersList.


        :param items: The items of this CloudEndureUsersList.  # noqa: E501
        :type: list[CloudEndureUser]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudEndureUsersList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloudEndureUsersList):
            return False
