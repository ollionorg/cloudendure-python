# -*- coding: utf-8 -*-
"""Define the CloudEndure REST interface."""
...
class RESTResponse(io.IOBase):
    """Define the CloudEndure REST Response."""
...
class RESTClientObject:
    """Define the CloudEndure REST Client Object."""
    ...
    def request(
        ...
        headers["X-XSRF-TOKEN"] = "Ykua549wkGxHPsV4fnncbw==\\012"
        ...
        try:
            ...
            # For `GET`, `HEAD`
                ...
                print("\n\nHEADERS IN REST: ", headers)
                print("\nPARAMS IN REST: ", query_params)
                r = self.pool_manager.request(
                    method,
                    url,
                    fields=query_params,
...
class ApiException(Exception):
    ...
    def __str__(self):
        """Define the custom string error messages for exception."""
