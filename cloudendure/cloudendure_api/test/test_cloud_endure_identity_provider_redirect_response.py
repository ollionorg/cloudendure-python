...
class TestCloudEndureIdentityProviderRedirectResponse(unittest.TestCase):
    """CloudEndureIdentityProviderRedirectResponse unit test stubs"""
    ...
    def testCloudEndureIdentityProviderRedirectResponse(self):
        """Test CloudEndureIdentityProviderRedirectResponse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = cloudendure_api.models.cloud_endure_identity_provider_redirect_response.CloudEndureIdentityProviderRedirectResponse()  # noqa: E501
        pass
