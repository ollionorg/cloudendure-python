...
class TestCloudEndureMachineReplicationConfiguration(unittest.TestCase):
    """CloudEndureMachineReplicationConfiguration unit test stubs"""
    ...
    def testCloudEndureMachineReplicationConfiguration(self):
        """Test CloudEndureMachineReplicationConfiguration"""
        # FIXME: construct object with mandatory attributes with example values
        # model = cloudendure_api.models.cloud_endure_machine_replication_configuration.CloudEndureMachineReplicationConfiguration()  # noqa: E501
        pass
