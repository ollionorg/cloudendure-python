...
class BlueprintDisks(ModelNormal):
    ...
    allowed_values = {
        ("type",): {
            ...
            "STANDARD": "STANDARD",
            "SSD": "SSD",
            "PROVISIONED_SSD": "PROVISIONED_SSD",
            "ST1": "ST1",
            "SC1": "SC1",
            "PROVISIONED_IO2": "PROVISIONED_IO2",
            "GP3": "GP3",
        },
    }

    validations = {
        ("iops",): {"inclusive_minimum": 0,},
        ("throughput",): {"inclusive_minimum": 0,},
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """BlueprintDisks - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): The type of disk to allocate in the target machine. COPY_ORIGIN will use the source setting.. [optional]  # noqa: E501
            iops (int): [optional]  # noqa: E501
            throughput (int): [optional]  # noqa: E501
            name (str): Disk name as appears in the source machine object.. [optional]  # noqa: E501
        """
