...
class CloudCredentials(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            public_key (str): The public part of the Cloud credentials. For AWS - access key ID; for GCP - user email; for Azure - SHA1 digestion of the certificate file. . [optional]  # noqa: E501
            account_identifier (str): An ID provided by the cloud for the user account.. [optional]  # noqa: E501
