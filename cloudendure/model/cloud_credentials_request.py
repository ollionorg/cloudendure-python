...
class CloudCredentialsRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, cloud_id, *args, **kwargs):  # noqa: E501
        """CloudCredentialsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            public_key (str): The public part of the Cloud credentials. For AWS - The access key ID, For GCP and Azure - N/A.. [optional]  # noqa: E501
            name (str): An optional (can be empty), user provided, descriptive name.. [optional]  # noqa: E501
            private_key (str): Cloud credentials secret, Base64-encoded. For AWS - The secret access key, For GCP - The private key in JSON format, For Azure - The certificate file.. [optional]  # noqa: E501
            account_identifier (str): Cloud account identifier. For AWS - N/A, For GCP - The project ID, For Azure - The subscription ID.. [optional]  # noqa: E501
