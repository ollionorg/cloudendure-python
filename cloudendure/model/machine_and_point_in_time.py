...
class MachineAndPointInTime(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "point_in_time_id": (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        "point_in_time_id": "pointInTimeId",  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, machine_id, *args, **kwargs):  # noqa: E501
        """MachineAndPointInTime - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            point_in_time_id (str): The ID of the pointInTime to launch a target machine from. If omitted, CloudEndure will use the latest pointInTime.. [optional]  # noqa: E501
        """
