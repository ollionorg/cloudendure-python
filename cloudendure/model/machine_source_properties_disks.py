...
class MachineSourcePropertiesDisks(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_protected, name, *args, **kwargs):  # noqa: E501
        """MachineSourcePropertiesDisks - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            size (int): Disk size (in Bytes).. [optional]  # noqa: E501
        """
