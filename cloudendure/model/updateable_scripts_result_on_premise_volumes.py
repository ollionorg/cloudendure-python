...
class UpdateableScriptsResultOnPremiseVolumes(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """UpdateableScriptsResultOnPremiseVolumes - a model defined in OpenAPI
