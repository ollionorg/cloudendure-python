...
class TestUpdateableScriptsResultOnPremiseVolumes(unittest.TestCase):
    """UpdateableScriptsResultOnPremiseVolumes unit test stubs"""
    ...
    def testUpdateableScriptsResultOnPremiseVolumes(self):
        """Test UpdateableScriptsResultOnPremiseVolumes"""
        # FIXME: construct object with mandatory attributes with example values
        # model = UpdateableScriptsResultOnPremiseVolumes()  # noqa: E501
        pass
